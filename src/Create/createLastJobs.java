...
public class createLastJobs{
	...
	out.println("#PBS -l nodes=2:ppn=8,walltime=8:00:00");                                              
	...
	/* The actual alignment */
        out.println("lastal -Q1 -e120 -i1 "+ALIGNER_REF+" "+INPUT_DIR+ISOLATE_ID+"_1"+COR_EXTENSION+".fq > "+OUTPUT_DIR+ISOLATE_DIR+"rOne.maf");
	out.println("lastal -Q1 -e120 -i1 "+ALIGNER_REF+" "+INPUT_DIR+ISOLATE_ID+"_2"+COR_EXTENSION+".fq > "+OUTPUT_DIR+ISOLATE_DIR+"rTwo.maf");
	out.println("last-pair-probs.py "+OUTPUT_DIR+ISOLATE_DIR+"rOne.maf "+OUTPUT_DIR+ISOLATE_DIR+"rTwo.maf > "+OUTPUT_DIR+ISOLATE_DIR+"r.maf" );
	out.println("maf-convert.py -d sam "+OUTPUT_DIR+ISOLATE_DIR+"r.maf > "+OUTPUT_DIR+ISOLATE_DIR+"r.sam");
	out.println("rm "+OUTPUT_DIR+ISOLATE_DIR+"rOne.maf");
	out.println("rm "+OUTPUT_DIR+ISOLATE_DIR+"rTwo.maf\n");
