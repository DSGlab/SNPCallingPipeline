...
public class GetIntraClonalSNPs {
    public static void main ( String[] args ) throws Exception {
        ArrayList<String> HQsnpList = getSNPs("/Users/juliofdiaz/Dropbox/CF/snp_calling/DOLOSA_AU0158/snpList.txt");
        ...
        String suffix = "/r.vcf";
        String workingDir = "/Users/juliofdiaz/Dropbox/CF/snp_calling/DOLOSA_AU0158/";
    ...
    public static LinkedHashMap<String, VCFHolder> getAllSNPCalls(String prefix, String suffix, String[] ids)
        ...
        for ( String id: ids ) {
            VCFHolder vcfh = new VCFHolder(prefix + id + "-COR_BWA" + suffix);
